...
urlpatterns = [
    ...
    path('mybooks/', views.LoanedBooksByUserListView, name='my-borrowed'),
    path('allborrowed/', views.AllBorrowedBooksView, name='all-borrowed'),
    ...
    path('languages/', views.LanguageListView, name='languages'),
    ...
    path('bookinstances/', views.BookInstanceListView, name='bookinstances'),
